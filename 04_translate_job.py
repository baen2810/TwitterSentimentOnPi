...
from helpers import translate_tweets
from config import data_cleaned, data_translated, move_data_translated
...
if __name__ == '__main__':
    ...
    # MODIFY I/O
    source_dir = root_dir + data_cleaned
    target_dir = root_dir + data_translated
    processed_dir = source_dir + wf + data_processed
    error_dir = source_dir + wf + data_error
    move = move_data_translated
